...
** Last update Sun Mar 18 19:55:57 2012 mathias lang
*/
...
# if !defined(__cplusplus)
  /*
   * If you use C++, you have to define it on your own.
   * Behing picky about types is not always so good.
   */
   ...
   * Little add
   */
  int	mlx_nonblocking_loop(void *mlx_ptr, int timeout);
